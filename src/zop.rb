...
def level_one
    ...
    puts "-------------------------------------------------------------------------------------------------------------------------------".colorize(:light_green,)
    questions = [
        Question.new(Q01, "a", "Easy"),
        Question.new(Q02, "a", "Hard"),
        Question.new(Q03, "a", "Easy"),
        Question.new(Q04, "a", "Easy"),
        Question.new(Q05, "b", "Easy"),
        Question.new(Q06, "a", "Hard"),
        Question.new(Q07, "d", "Easy"),
        Question.new(Q08, "a", "Hard"),
        Question.new(Q09, "c", "Easy"),
        Question.new(Q10, "b", "Hard"),
        Question.new(Q11, "b", "Hard"),
        Question.new(Q12, "b", "Hard"),
        Question.new(Q13, "b", "Hard"),
        Question.new(Q14, "b", "Hard"),
        Question.new(Q15, "b", "Hard"),
        Question.new(Q16, "b", "Hard"),
        Question.new(Q17, "b", "Hard"),
        Question.new(Q18, "b", "Hard"),
        Question.new(Q19, "b", "Hard"),
        Question.new(Q20, "b", "Hard"),
        Question.new(Q21, "b", "Hard"),
        Question.new(Q22, "b", "Hard"),
        Question.new(Q23, "b", "Hard"),
        Question.new(Q24, "b", "Hard"),
        Question.new(Q25, "b", "Hard"),
        Question.new(Q26, "b", "Hard"),
        Question.new(Q27, "b", "Hard"),
        Question.new(Q28, "b", "Hard"),
        Question.new(Q29, "b", "Hard"),
        Question.new(Q30, "b", "Hard"),
    ]
